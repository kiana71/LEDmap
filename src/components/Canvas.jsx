...
const Canvas = () => {
  ...
  return (
    <div className="bg-white overflow-y-auto w-full h-full pt-14 lg:pr-80 pr-0 top-0">
      {/* Main Drawing Container - Fixed layout without responsiveness */}
      <div className="w-full h-full border border-gray-300 p-6 flex flex-col">
        {/* Upper Section */}
        <div className="flex-1 flex flex-row justify-center">
          {/* Main Content Area */}

          <div className=" flex justify-center relative w-2/4 border-4 border-gray-800 bg-blue-100 bg-opacity-30">
          ...
          {/* Dimension Boxes Area */}
          <div className="w-1/4 p-6 ">
            <div className="w-full h-80 flex flex-col space-y-4 ">
              {/* Screen Dimensions Box */}
              <div className="border-2 border-black p-2 bg-purple-100 bg-opacity-30 w-full h-40">
                <div className="font-bold text-sm">Screen Dimensions:</div>
              </div>

              {/* Niche Dimensions Box */}
              <div className="border-2 border-black p-2 bg-purple-100 bg-opacity-30 w-full h-40">
                <div className="font-bold text-sm">Niche Dimensions:</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="h-32 mt-6 flex space-x-6">
          {/* Notes Section */}
          <div className="flex-1 border-2 border-gray-400 bg-yellow-100 bg-opacity-30 p-2">
            <div className="font-bold text-sm">NOTES:</div>
          </div>

          {/* Installation Table */}
          <div className="flex-1 border-2 border-gray-400 bg-orange-100 bg-opacity-30"></div>
        </div>
      </div>
    </div>
  );
