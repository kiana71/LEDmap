...
// Main FloatingToolbar component with direct fixes
const FloatingToolbar = () => {
    ...
    const handleSelection = () => {
      ...
      if (selection.toString().trim().length > 0) {
        try {
          ...
          // DIRECT FIX: Always ensure minimum 20px from left edge
  ...
  // COMPLETELY REWRITTEN formatting function for list support
